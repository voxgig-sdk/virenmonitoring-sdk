# Virenmonitoring Golang SDK Reference

Complete API reference for the Virenmonitoring Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *VirenmonitoringSDK`
...
#### `DatasetMetadata(data map[string]any) VirenmonitoringEntity`

Create a new `DatasetMetadata` entity instance. Pass `nil` for no initial data.

#### `VirusMonitoring(data map[string]any) VirenmonitoringEntity`

Create a new `VirusMonitoring` entity instance. Pass `nil` for no initial data.

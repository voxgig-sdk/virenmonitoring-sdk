...
type VirenmonitoringSDK struct {
	Mode     string
...
func (sdk *VirenmonitoringSDK) OptionsMap() map[string]any {
...
func (sdk *VirenmonitoringSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *VirenmonitoringSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *VirenmonitoringSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *VirenmonitoringSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *VirenmonitoringSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *VirenmonitoringSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("VirenmonitoringSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *VirenmonitoringSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *VirenmonitoringSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("VirenmonitoringSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *VirenmonitoringSDK {
	...
	sdk := NewVirenmonitoringSDK(sdkopts)
	sdk.Mode = "test"

...
const testSeed = `map[string]any{"entity": map[string]any{"dataset_metadata": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "virus_monitoring": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`

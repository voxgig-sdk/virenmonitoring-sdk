...
func NewDatasetMetadataEntity(client *core.VirenmonitoringSDK, entopts map[string]any) *DatasetMetadataEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DatasetMetadataEntity) GetName() string { return e.name }
...
func (e *DatasetMetadataEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DatasetMetadataEntity) Deleted() bool {
	return e.deleted
}


func (e *DatasetMetadataEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDatasetMetadataEntity(e.client, opts)
}

func (e *DatasetMetadataEntity) Data(args ...any) any {
...
func (e *DatasetMetadataEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DatasetMetadata; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DatasetMetadataEntity) DataTyped(data ...DatasetMetadata) DatasetMetadata {
	if len(data) > 0 {
		return typedFrom[DatasetMetadata](e.Data(asMap(data[0])))
	}
	return typedFrom[DatasetMetadata](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DatasetMetadata (all fields
// optional at the wire level).
func (e *DatasetMetadataEntity) MatchTyped(match ...DatasetMetadata) DatasetMetadata {
	if len(match) > 0 {
		return typedFrom[DatasetMetadata](e.Match(asMap(match[0])))
	}
	return typedFrom[DatasetMetadata](e.Match())
}
...
func (e *DatasetMetadataEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DatasetMetadataEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DatasetMetadataEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DatasetMetadataListMatch and returns []DatasetMetadata. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DatasetMetadataEntity) ListTyped(reqmatch DatasetMetadataListMatch, ctrl map[string]any) ([]DatasetMetadata, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DatasetMetadata](res), nil
}



func (e *DatasetMetadataEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DatasetMetadataEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DatasetMetadataEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DatasetMetadataEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

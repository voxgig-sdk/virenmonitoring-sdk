...
type VirusMonitoringEntity struct {
	name    string
	client  *core.VirenmonitoringSDK
...
func NewVirusMonitoringEntity(client *core.VirenmonitoringSDK, entopts map[string]any) *VirusMonitoringEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VirusMonitoringEntity) GetName() string { return e.name }
...
func (e *VirusMonitoringEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VirusMonitoringEntity) Deleted() bool {
	return e.deleted
}


func (e *VirusMonitoringEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVirusMonitoringEntity(e.client, opts)
}

func (e *VirusMonitoringEntity) Data(args ...any) any {
...
func (e *VirusMonitoringEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an VirusMonitoring; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VirusMonitoringEntity) DataTyped(data ...VirusMonitoring) VirusMonitoring {
	if len(data) > 0 {
		return typedFrom[VirusMonitoring](e.Data(asMap(data[0])))
	}
	return typedFrom[VirusMonitoring](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through VirusMonitoring (all fields
// optional at the wire level).
func (e *VirusMonitoringEntity) MatchTyped(match ...VirusMonitoring) VirusMonitoring {
	if len(match) > 0 {
		return typedFrom[VirusMonitoring](e.Match(asMap(match[0])))
	}
	return typedFrom[VirusMonitoring](e.Match())
}
...
func (e *VirusMonitoringEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VirusMonitoringEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *VirusMonitoringEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VirusMonitoringListMatch and returns []VirusMonitoring. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VirusMonitoringEntity) ListTyped(reqmatch VirusMonitoringListMatch, ctrl map[string]any) ([]VirusMonitoring, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[VirusMonitoring](res), nil
}



func (e *VirusMonitoringEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VirusMonitoringEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VirusMonitoringEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VirusMonitoringEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility

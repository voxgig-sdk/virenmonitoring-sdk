...
class VirenmonitoringTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VirenmonitoringTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = VirenmonitoringTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = VirenmonitoringTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")

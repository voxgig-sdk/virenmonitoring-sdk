...
// Virenmonitoring SDK feature test
//
...
class FtCtrl extends VirenmonitoringControl
{
...
class FtClient
{
    ...
    private VirenmonitoringUtility $utility;

    public function __construct(VirenmonitoringUtility $utility, array $options)
    {
    ...
    public function get_utility(): VirenmonitoringUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (VirenmonitoringContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public VirenmonitoringContext $rootctx;
    ...
    public function __construct(
        ...
        $utility->fetcher = $server ?? function (VirenmonitoringContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = VirenmonitoringConfig::make_feature($name);
    ...
    private static function buildUrl(VirenmonitoringSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof VirenmonitoringError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new VirenmonitoringResponse($fetched);
        }
    ...
    private function fail(VirenmonitoringContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (VirenmonitoringContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;

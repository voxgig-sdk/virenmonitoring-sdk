...
// Virenmonitoring SDK pipeline test
//
...
{
    private static function utility(): VirenmonitoringUtility
    {
        return new VirenmonitoringUtility();
    }
    ...
    private static function ctx(array $over = []): VirenmonitoringContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new VirenmonitoringContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new VirenmonitoringOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof VirenmonitoringError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new VirenmonitoringOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = VirenmonitoringMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new VirenmonitoringOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = VirenmonitoringMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new VirenmonitoringOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = VirenmonitoringMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new VirenmonitoringSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = VirenmonitoringMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        ...
        [, $err] = VirenmonitoringMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new VirenmonitoringSpec([]),
            'response' => null,
            'result' => new VirenmonitoringResult([]),
        ]);
        [, $err] = VirenmonitoringMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new VirenmonitoringSpec(['step' => 's']),
            'response' => new VirenmonitoringResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new VirenmonitoringResult([]),
        ]);
        [, $err] = VirenmonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new VirenmonitoringSpec(['step' => 's']),
            'response' => new VirenmonitoringResponse(self::resp(200, ['v' => 1])),
            'result' => new VirenmonitoringResult([]),
        ]);
        [, $err] = VirenmonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new VirenmonitoringSpec(['step' => 's']),
            'response' => new VirenmonitoringResponse(self::resp(200, ['v' => 2])),
            'result' => new VirenmonitoringResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        VirenmonitoringMakeResponse::call($ctx);
    ...
    {
        $preset = new VirenmonitoringResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new VirenmonitoringSpec([]),
            'response' => new VirenmonitoringResponse([]),
            'result' => new VirenmonitoringResult([]),
        ...
        [$got, $err] = VirenmonitoringMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new VirenmonitoringResult([])]);
        [, $err] = VirenmonitoringMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new VirenmonitoringSpec([]), 'result' => null]);
        [, $err] = VirenmonitoringMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new VirenmonitoringSpec(['step' => 's']),
            'result' => new VirenmonitoringResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new VirenmonitoringOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = VirenmonitoringMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new VirenmonitoringSpec(['step' => 's']),
            'result' => new VirenmonitoringResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new VirenmonitoringOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = VirenmonitoringMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new VirenmonitoringResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new VirenmonitoringSpec([]),
            'result' => new VirenmonitoringResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = VirenmonitoringMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = VirenmonitoringMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new VirenmonitoringError('boom', 'boom');
        $utility->fetcher = function (VirenmonitoringContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new VirenmonitoringSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = VirenmonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (VirenmonitoringContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = VirenmonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(VirenmonitoringResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        VirenmonitoringMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (VirenmonitoringContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new VirenmonitoringSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = VirenmonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new VirenmonitoringResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new VirenmonitoringSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = VirenmonitoringMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = VirenmonitoringMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = VirenmonitoringMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new VirenmonitoringResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, VirenmonitoringDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new VirenmonitoringResult(['ok' => false])]);
        $this->expectException(VirenmonitoringError::class);
        VirenmonitoringDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new VirenmonitoringResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', VirenmonitoringMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        VirenmonitoringMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new VirenmonitoringBaseFeature();
        $b = new VirenmonitoringBaseFeature();
        VirenmonitoringFeatureAdd::call($ctx, $a);
        VirenmonitoringFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): VirenmonitoringBaseFeature
    {
        $f = new VirenmonitoringBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        VirenmonitoringFeatureAdd::call($ctx, self::named_feature('a'));
        VirenmonitoringFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        VirenmonitoringFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        VirenmonitoringFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        VirenmonitoringFeatureAdd::call($ctx, $replace);
        ...
        VirenmonitoringFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): VirenmonitoringContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new VirenmonitoringSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = VirenmonitoringPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        VirenmonitoringPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new VirenmonitoringResponse(['headers' => null]),
            'result' => new VirenmonitoringResult([]),
        ]);
        VirenmonitoringResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        VirenmonitoringResultBody::call($ctx);

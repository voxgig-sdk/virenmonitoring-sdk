...
// Virenmonitoring SDK proxy feature
...
class VirenmonitoringProxyFeature extends VirenmonitoringBaseFeature
{
    ...
    public function init(VirenmonitoringContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (VirenmonitoringContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

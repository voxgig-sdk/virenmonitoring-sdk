...
// Virenmonitoring SDK cache feature
...
class VirenmonitoringCacheFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _through(VirenmonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

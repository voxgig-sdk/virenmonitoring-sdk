...
// Virenmonitoring SDK netsim feature
...
class VirenmonitoringNetsimFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _simulate(VirenmonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(VirenmonitoringContext $ctx, array $applied): void
    {
        $client = $this->client;

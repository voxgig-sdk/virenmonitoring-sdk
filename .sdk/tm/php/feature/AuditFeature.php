...
// Virenmonitoring SDK audit feature
...
class VirenmonitoringAuditFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _emit(VirenmonitoringContext $ctx, string $outcome): void
    {

...
// Virenmonitoring SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class VirenmonitoringTestFeature extends VirenmonitoringBaseFeature
{
    ...
    public function init(VirenmonitoringContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (VirenmonitoringContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = VirenmonitoringParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (VirenmonitoringContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(VirenmonitoringContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = VirenmonitoringParam::call($ctx, $k);

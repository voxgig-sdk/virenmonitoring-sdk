...
// Virenmonitoring SDK utility type

class VirenmonitoringUtility
{
    ...
    public static function copy(VirenmonitoringUtility $src): VirenmonitoringUtility
    {
        $u = new VirenmonitoringUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;

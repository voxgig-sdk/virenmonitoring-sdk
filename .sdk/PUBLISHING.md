...
|---|---|---|
| `ts/` | @voxgig-sdk/virenmonitoring-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/virenmonitoring-sdk \
      --repository voxgig-sdk/virenmonitoring-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/virenmonitoring-sdk` shows it, and
`npm trust revoke @voxgig-sdk/virenmonitoring-sdk --id=<id>` removes it.

...
type Args struct {
	Entity string         `json:"entity" jsonschema:"dataset_metadata | virus_monitoring"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.VirenmonitoringSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "virenmonitoring_list",
		Description: "List records from Virenmonitoring. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "virenmonitoring_load",
		Description: "Load a single record from Virenmonitoring. " +
...
func runOp(client *sdk.VirenmonitoringSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.VirenmonitoringSDK, name string) (sdk.VirenmonitoringEntity, error) {
	switch strings.ToLower(name) {
	case "dataset_metadata":
		return client.DatasetMetadata(nil), nil
	case "virus_monitoring":
		return client.VirusMonitoring(nil), nil

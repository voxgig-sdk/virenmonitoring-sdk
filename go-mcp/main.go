// Command Virenmonitoring-mcp is an MCP server exposing the Virenmonitoring
// SDK as MCP tools.
//
// Two tools are registered:
//
//	Virenmonitoring_list  — list records of an entity
//	Virenmonitoring_load  — load a single record of an entity
//

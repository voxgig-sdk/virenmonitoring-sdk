...
describe('DatasetMetadataEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['list']) {
      if (maybeSkipControl(t, 'entityOp', 'dataset_metadata.' + op, live)) return
    }
    ...
    let dataset_metadata_ref01_data = Object.values(setup.data.existing.dataset_metadata)[0] as any
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/dataset_metadata/DatasetMetadataTestData.json')

...
describe('DatasetMetadataDirect', async () => {
  ...
  test('direct-list-dataset_metadata', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-dataset_metadata', setup.live)) return

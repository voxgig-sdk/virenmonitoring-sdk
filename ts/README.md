# Virenmonitoring TypeScript SDK



The TypeScript SDK for the Virenmonitoring API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.DatasetMetadata()` — each with a small set of operations (`list`)
...
| `tester(testopts?, sdkopts?)` | `VirenmonitoringSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `VirenmonitoringSDK.test(testopts?, sdkopts?)` | `VirenmonitoringSDK` | Create a test-mode client. |
...
| `client` | `client(): VirenmonitoringSDK` | Return the parent SDK client. |
...
virenmonitoring/
├── src/
│   ├── VirenmonitoringSDK.ts        # Main SDK class

...
function envOverride(m) {
    if ('TRUE' === process.env.VIRENMONITORING_TEST_LIVE ||
        'TRUE' === process.env.VIRENMONITORING_TEST_OVERRIDE) {
    ...
    m.VIRENMONITORING_TEST_EXPLAIN = process.env.VIRENMONITORING_TEST_EXPLAIN || m.VIRENMONITORING_TEST_EXPLAIN;
    return m;
}

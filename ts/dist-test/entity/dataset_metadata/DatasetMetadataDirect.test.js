...
(0, node_test_1.describe)('DatasetMetadataDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.VirenmonitoringSDK({
    ...
    (0, node_test_1.test)('direct-list-dataset_metadata', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-dataset_metadata', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.VirenmonitoringSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['VIRENMONITORING_TEST_DATASET_METADATA_ENTID'];
    ...
    const client = new __1.VirenmonitoringSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=DatasetMetadataDirect.test.js.map
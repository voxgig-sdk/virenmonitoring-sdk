# Virenmonitoring SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions VirenmonitoringSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both VirenmonitoringSDK(...) and VirenmonitoringSDK.test(...) become
#      VirenmonitoringSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "virenmonitoring_sdk"
_SDK_CLASS = "VirenmonitoringSDK"
...
_ENTITIES = {
    ...
    "VirusMonitoring": "virus_monitoring",
}

...
from virenmonitoring_sdk.utility import register

# Load features
from virenmonitoring_sdk.feature.base_feature import VirenmonitoringBaseFeature
from virenmonitoring_sdk.features import _has_feature, _make_feature
...
class VirenmonitoringSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = VirenmonitoringUtility()
    ...
    def get_utility(self):
        return VirenmonitoringUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("VirenmonitoringSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def DatasetMetadata(self, data=None) -> "DatasetMetadataEntity":
        ...
        from virenmonitoring_sdk.entity.dataset_metadata_entity import DatasetMetadataEntity
    ...
    def VirusMonitoring(self, data=None) -> "VirusMonitoringEntity":
        ...
        from virenmonitoring_sdk.entity.virus_monitoring_entity import VirusMonitoringEntity

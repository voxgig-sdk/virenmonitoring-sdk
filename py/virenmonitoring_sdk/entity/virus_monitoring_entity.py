...
from virenmonitoring_sdk.virenmonitoring_types import (
    VirusMonitoring,
    VirusMonitoringListMatch,
)
...
class VirusMonitoringEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return VirusMonitoringEntity(self._client, opts)
    ...
    def data_get(self) -> VirusMonitoring:
    ...
    def match_get(self) -> VirusMonitoring:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[VirusMonitoring]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.VirusMonitoring().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

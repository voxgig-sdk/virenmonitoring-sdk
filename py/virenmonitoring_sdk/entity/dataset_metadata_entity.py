...
class DatasetMetadataEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return DatasetMetadataEntity(self._client, opts)
    ...
    def data_get(self) -> DatasetMetadata:
    ...
    def match_get(self) -> DatasetMetadata:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[DatasetMetadata]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.DatasetMetadata().list() works with no args.
        if reqmatch is None:
            reqmatch = {}

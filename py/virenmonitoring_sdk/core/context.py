...
from virenmonitoring_sdk.core.control import VirenmonitoringControl
...
from virenmonitoring_sdk.core.helpers import get_ctx_prop, to_map
...
class VirenmonitoringContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = VirenmonitoringControl()
        ...
        if isinstance(sp, VirenmonitoringSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, VirenmonitoringResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, VirenmonitoringResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return VirenmonitoringOperation({})
    ...
    def make_error(self, code, msg):
        return VirenmonitoringError(code, msg, self)

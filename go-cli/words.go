...
func registerSDKWords(r *eng.Registry, client *sdk.VirenmonitoringSDK) {
...
func runOp(client *sdk.VirenmonitoringSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

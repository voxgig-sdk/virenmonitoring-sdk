...
AQL-driven CLI and REPL for the Virenmonitoring SDK. Positional arguments are
...
```sh
go build -o virenmonitoring-cli ./...
```
...
./virenmonitoring-cli load 1 dataset_metadata
./virenmonitoring-cli load '{id:1}' dataset_metadata

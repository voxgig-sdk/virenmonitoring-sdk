...
class DatasetMetadataEntity
  ...
  def make
    opts = @_entopts.dup
    DatasetMetadataEntity.new(@_client, opts)
  end
  ...
  # @return [DatasetMetadata, Hash] the current DatasetMetadata data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of DatasetMetadata fields)
  def match_get
  ...
  #
  # @param reqmatch [DatasetMetadataListMatch, Hash, nil] match filter (any subset of
  #   DatasetMetadata fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<DatasetMetadata>, Array] the matching DatasetMetadata items; raises VirenmonitoringError on failure

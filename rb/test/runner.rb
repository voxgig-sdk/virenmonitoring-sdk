...
module VirenmonitoringTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("VIRENMONITORING_TEST_LIVE")
    override = getenv("VIRENMONITORING_TEST_OVERRIDE")
    ...
    explain = getenv("VIRENMONITORING_TEST_EXPLAIN")
    m["VIRENMONITORING_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = VirenmonitoringTestRunner
Helpers = VirenmonitoringHelpers
Vs = VoxgigStruct

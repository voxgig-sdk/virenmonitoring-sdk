...
#      offline in seeded test mode (VirenmonitoringSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "Virenmonitoring_sdk.rb")
  SDK_CLASS = "VirenmonitoringSDK"

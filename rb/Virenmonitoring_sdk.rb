...
class VirenmonitoringSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = VirenmonitoringHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = VirenmonitoringHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, VirenmonitoringFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    VirenmonitoringUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    params = VirenmonitoringHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = VirenmonitoringHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = VirenmonitoringHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = VirenmonitoringError.new(
        "graphql_error", "VirenmonitoringSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = VirenmonitoringSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end

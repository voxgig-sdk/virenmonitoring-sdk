...
local VirenmonitoringSDK = {}
VirenmonitoringSDK.__index = VirenmonitoringSDK
...
VirenmonitoringSDK._make_feature = _make_feature


function VirenmonitoringSDK.new(options)
  local self = setmetatable({}, VirenmonitoringSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function VirenmonitoringSDK:options_map()
...
function VirenmonitoringSDK:get_utility()
  return Utility.copy(self._utility)
end


function VirenmonitoringSDK:get_root_ctx()
  return self._rootctx
end


function VirenmonitoringSDK:prepare(fetchargs)
...
function VirenmonitoringSDK:direct(fetchargs)
...
function VirenmonitoringSDK:_op_allowed(op)
  local allow = vs.getpath(self.options, "allow.op")
  return type(allow) == "string" and allow:find(op, 1, true) ~= nil
end


function VirenmonitoringSDK:_op_denied(op)
  local allow = vs.getpath(self.options, "allow.op")
  if type(allow) ~= "string" then allow = "" end
  return {
    ok = false,
    err = "VirenmonitoringSDK: " .. op .. ": operation not allowed by" ..
...
-- by passing it.
function VirenmonitoringSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function VirenmonitoringSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "VirenmonitoringSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function VirenmonitoringSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = VirenmonitoringSDK.new(sdkopts)
  sdk.mode = "test"

...
describe("DatasetMetadataDirect", function()
  it("should direct-list-dataset_metadata", function()
    local setup = dataset_metadata_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-dataset_metadata", setup.live and "live" or "unit")
...
function dataset_metadata_direct_setup(mockres)

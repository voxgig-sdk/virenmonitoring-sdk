...
function runner.env_override(m)
  local live = runner.getenv("VIRENMONITORING_TEST_LIVE")
  local override = runner.getenv("VIRENMONITORING_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("VIRENMONITORING_TEST_EXPLAIN")

...
describe("VirusMonitoringDirect", function()
  it("should direct-list-virus_monitoring", function()
    local setup = virus_monitoring_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-virus_monitoring", setup.live and "live" or "unit")
...
function virus_monitoring_direct_setup(mockres)

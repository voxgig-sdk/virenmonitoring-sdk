...
local VirusMonitoringEntity = {}
VirusMonitoringEntity.__index = VirusMonitoringEntity


function VirusMonitoringEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VirusMonitoringEntity)
  self._name = "virus_monitoring"
  self._client = client
...
function VirusMonitoringEntity:get_name()
  return self._name
end


function VirusMonitoringEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VirusMonitoringEntity.new(self._client, opts)
end
...
function VirusMonitoringEntity:mark_deleted()
  self._deleted = true
end


function VirusMonitoringEntity:deleted()
  return true == self._deleted
end


function VirusMonitoringEntity:data_set(args)
  if args ~= nil then
...
function VirusMonitoringEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VirusMonitoringEntity:match_set(args)
  if args ~= nil then
...
function VirusMonitoringEntity:match_get()
...
function VirusMonitoringEntity:stream(action, args, callopts)
...
function VirusMonitoringEntity:_run_op(ctx, post_done)
  local utility = self._utility

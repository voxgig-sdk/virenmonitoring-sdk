...
// Virenmonitoring SDK streaming feature
...
class VirenmonitoringStreamingFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _iterate(VirenmonitoringResult $result): \Generator
    {
    ...
    private function _streamable(VirenmonitoringContext $ctx): bool
    {

...
// Virenmonitoring SDK clienttrack feature
...
class VirenmonitoringClienttrackFeature extends VirenmonitoringBaseFeature
{
    ...
    public function PostConstruct(VirenmonitoringContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Virenmonitoring-SDK';

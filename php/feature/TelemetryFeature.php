...
// Virenmonitoring SDK telemetry feature
...
class VirenmonitoringTelemetryFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _close(VirenmonitoringContext $ctx, bool $ok): void
    {

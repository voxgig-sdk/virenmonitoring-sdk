...
// Virenmonitoring SDK timeout feature
...
class VirenmonitoringTimeoutFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _with_timeout(VirenmonitoringContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(VirenmonitoringContext $_ctx, float $ms): void
    {
        $client = $this->client;

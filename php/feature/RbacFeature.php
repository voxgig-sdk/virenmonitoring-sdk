...
// Virenmonitoring SDK rbac feature
...
class VirenmonitoringRbacFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _required(VirenmonitoringContext $ctx): ?string
    {
    ...
    private function _reject(VirenmonitoringContext $ctx, string $required): void
    {
    ...
    private function _track(VirenmonitoringContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

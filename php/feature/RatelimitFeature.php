...
// Virenmonitoring SDK ratelimit feature
...
class VirenmonitoringRatelimitFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _acquire(VirenmonitoringContext $ctx): void
    {
    ...
    private function _track(VirenmonitoringContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

...
// Virenmonitoring SDK debug feature
...
class VirenmonitoringDebugFeature extends VirenmonitoringBaseFeature
{
    ...
    private function _finish(VirenmonitoringContext $ctx, bool $ok): void
    {

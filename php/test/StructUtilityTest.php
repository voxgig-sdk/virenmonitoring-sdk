...
// Virenmonitoring SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = VirenmonitoringOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(VirenmonitoringOmni::structfix($now, Struct::undef()))
                        !== json_encode(VirenmonitoringOmni::structfix($val, Struct::undef()))) {

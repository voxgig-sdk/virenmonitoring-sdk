...
class DatasetMetadataDirectTest extends TestCase
{
    public function test_direct_list_dataset_metadata(): void
    {
        $setup = dataset_metadata_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-dataset_metadata", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

...
// Virenmonitoring SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (VirenmonitoringSDK::test)
...
{
    private const SDK_CLASS = 'VirenmonitoringSDK';
    ...
    private const SDK_BASE = 'virenmonitoring_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../virenmonitoring_sdk.php';

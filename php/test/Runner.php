...
class VirenmonitoringTestRunner
{
    ...
    {
        $live = self::getenv('VIRENMONITORING_TEST_LIVE');
        $override = self::getenv('VIRENMONITORING_TEST_OVERRIDE');
        ...
        $explain = self::getenv('VIRENMONITORING_TEST_EXPLAIN');
...
class_alias('VirenmonitoringTestRunner', 'Runner');
class_alias('VirenmonitoringHelpers', 'Helpers');

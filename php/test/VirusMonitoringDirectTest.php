...
class VirusMonitoringDirectTest extends TestCase
{
    public function test_direct_list_virus_monitoring(): void
    {
        $setup = virus_monitoring_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-virus_monitoring", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {

...
class VirenmonitoringSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = VirenmonitoringHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = VirenmonitoringHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!VirenmonitoringFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, VirenmonitoringFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return VirenmonitoringUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = VirenmonitoringHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = VirenmonitoringHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = VirenmonitoringHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new VirenmonitoringError($op . "_allow",
                "VirenmonitoringSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = VirenmonitoringHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new VirenmonitoringError("graphql_error",
                "VirenmonitoringSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function DatasetMetadata($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_dataset_metadata === null) {
                $this->_dataset_metadata = new DatasetMetadataEntity($this, null);
            }
            return $this->_dataset_metadata;
        }
        return new DatasetMetadataEntity($this, $data);
    }
    ...
    public function VirusMonitoring($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_virus_monitoring === null) {
                $this->_virus_monitoring = new VirusMonitoringEntity($this, null);
            }
            return $this->_virus_monitoring;
        }
        return new VirusMonitoringEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new VirenmonitoringSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}

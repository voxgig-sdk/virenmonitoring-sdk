...
// Virenmonitoring SDK utility: graphql
//
...
class VirenmonitoringGraphql
{
    ...
    // equivalent.
    public static function body(VirenmonitoringContext $ctx): mixed
    {
    ...
    public static function errors(VirenmonitoringContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

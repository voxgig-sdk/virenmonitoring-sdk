...
// Virenmonitoring SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class VirenmonitoringTransformResponse
{
    public static function call(VirenmonitoringContext $ctx): mixed
    {
        ...
        $transform = VirenmonitoringHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }

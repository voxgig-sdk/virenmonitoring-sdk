...
// Virenmonitoring SDK utility: result_basic

class VirenmonitoringResultBasic
{
    public static function call(VirenmonitoringContext $ctx): ?VirenmonitoringResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof VirenmonitoringError) ? $result->err->msg : (string)$result->err;

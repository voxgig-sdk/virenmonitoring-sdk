...
// Virenmonitoring SDK utility: fetcher

class VirenmonitoringFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; VirenmonitoringSDK/1.0)';
    ...
    public static function call(VirenmonitoringContext $ctx, string $fullurl, array $fetchdef): array
    {

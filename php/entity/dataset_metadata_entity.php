...
// Virenmonitoring SDK DatasetMetadata entity
...
class DatasetMetadataEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DatasetMetadataEntity($this->_client, $opts);
    }

    /**
     * @param DatasetMetadata|array $args DatasetMetadata data (assoc-array) to store.
     */
    ...
    /**
     * @return DatasetMetadata|array The current DatasetMetadata data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DatasetMetadata fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DatasetMetadata fields).
     */
    ...
    /**
     * List DatasetMetadata items matching the given filter.
     *
     * @param DatasetMetadataListMatch|array|null $reqmatch Match filter (any subset
     *   of DatasetMetadata fields) as an assoc-array; DatasetMetadataListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DatasetMetadata[]|array A list of DatasetMetadata items as assoc-arrays at

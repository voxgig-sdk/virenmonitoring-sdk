# Virenmonitoring PHP SDK



The PHP SDK for the Virenmonitoring API — an entity-oriented client using PHP conventions.
...
```
php/
├── virenmonitoring_sdk.php          -- Main SDK class
...
The main class (`virenmonitoring_sdk.php`) exports the SDK class
